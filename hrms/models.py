...
class Employee(models.Model):
    LANGUAGE = (('english','ENGLISH'),('urdu','URDU'),('tamil','TAMIL'),('french','FRENCH'))
    GENDER = (('male','MALE'), ('female', 'FEMALE'),('other', 'OTHER'))
    emp_id = models.CharField(max_length=70, default='emp')
    ...
    bank = models.CharField(max_length=25, default='RAK Bank ')
...
class Attendance (models.Model):
    ...
    def __str__(self):
        return 'Attendance -> '+str(self.date) + ' -> ' + str(self.staff) +'- >' + str(self.first_in)
